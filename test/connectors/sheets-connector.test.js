...
let connectorConfig = {
  testsPath: 'fakeSheetId/Tests',
  resultsPath: 'fakeSheetId/Results',
};
let apiHandler = {
...
describe('SheetsConnector unit test', () => {
  beforeEach(() => {
    connector = new SheetsConnector(connectorConfig, apiHandler, envVars);
  });

  it('flattens json to one-level object', async () => {
